...
const Register = () => {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        toast.success(
          "OTP verified successfully! You can now enable biometric authentication.",
          {
            position: "top-right",
            autoClose: 2000,
            hideProgressBar: false,
  ...
  const handleBiometricRegistration = async () => {
    try {
      console.log("Initiating biometric registration for email:", email);
      const response = await axios.post(
      ...
      console.log("Received registration options:", response.data);
      ...
      if (response.data.success) {
        ...
        if (verificationResponse.data.success) {
          toast.success("Biometric registration successful! Redirecting to dashboard...", {
            position: "top-right",
            autoClose: 2000,
            hideProgressBar: false,
            closeOnClick: true,
      ...
      const errorMessage =
        err.response?.data?.message || "Biometric registration failed.";
      toast.error(errorMessage, {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
      ...
      <div className="login-card">
        ...
        {!showOtpInput && !showBiometricOption ? (
          ...
          <div className="biometric-options">
            ...
            <p>
              Add fingerprint or facial recognition for faster, secure logins.
            </p>
            <button
              className="login-btn"
      ...
      {showTermsPopup && (
        <div className="register-popup">
          <div className="register-popup-content">
            ...
            <p>
              Effective Date: May 25, 2025 <br /><br />Please read these Terms and
      ...
      {showPrivacyPopup && (
        <div className="register-popup">
          <div className="register-popup-content">
            ...
            <p>
              Effective Date: May 25, 2025 <br /><br />Your privacy is not a feature. It’s a
