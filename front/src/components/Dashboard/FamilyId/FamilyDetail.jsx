...
const FamilyDetail = () => {
  ...
  const handleSaveAll = async () => {
    const payload = {
      ...
      driver_license_state_issued: formData.driverLicenseStateIssued,
      driver_license_expiration: formData.driver_license_expiration.split("T")[0] || null,
      aadhaar_number: formData.aadhaarNumber,
      pan_number: formData.panNumber,
      passport_number: formData.passport_number,
      passport_state_issued: formData.passportStateIssued,
      passport_expiration: formData.passportExpiration.split("T")[0] || null,
      notes: formData.notes,
      other_documents: formData.otherDocuments.map((doc) => ({
        id: doc.id?.toString().startsWith("other-") ? null : doc.id,
      ...
      try {
        ...
        if (data.success) {
          ...
          setFormData({
            ...
            driver_license_document: data.familyMember.driver_license_document || '',
            ...
            birth_certificate: data.familyMember.birth_certificate || null,
  ...
  const handleInputChange = async (e, docIndex = null) => {
    ...
    if (docIndex !== null) {
      ...
      try {
        const response = await fetch(`${import.meta.env.VITE_API_URL}/api/familyinfo/update/${id}`, {
          method: 'POST',
          credentials: 'include',
          body: formDataToSend,
        });
          ...
          <div className="family-detail-card-grid">
            ...
            >
              ...
              {formData.driver_license_document ?
                <img style={{ width: "100px" }} src={`${import.meta.env.VITE_API_URL}/images/${formData.driver_license_document}`} alt="Upload Icon" className="upload-icon" />
                : <div className="family-detail-card-upload">
              ...
              <div className="family-detail-input-group family-detail-single-column">
                ...
                <input
                  ...
                  value={formData.driver_license_expiration.split("T")[0]}
                  onChange={handleInputChange}
                  className="family-detail-text-input"
                />
              </div>
            ...
            >
              ...
              <div className="family-detail-input-group family-detail-single-column">
                ...
                <input
                  ...
                  value={formData.passportExpiration.split("T")[0]}
                  onChange={handleInputChange}
                  className="family-detail-text-input"
                />
              </div>
            ...
            >
              ...
              {formData.birth_certificate ?
                <img style={{ width: "100px" }} src={`${import.meta.env.VITE_API_URL}/images/${formData.birth_certificate}`} alt="Upload Icon" className="upload-icon" />
                : <div className="family-detail-card-upload">
                  <img src={UploadIcon} alt="Upload Icon" className="upload-icon" />
                  <div className="upload-text-group">
                    <p>Drag and drop files here</p>
              ...
              {formData.birth_certificate && (
                <p className="family-detail-file-name">
                  Uploaded: {typeof formData.birth_certificate === 'object' ? formData.birth_certificate.name : formData.birth_certificate.split('/').pop()}
                </p>
              )}
            </div>
